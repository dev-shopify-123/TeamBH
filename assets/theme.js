    ...
    FadingImages.prototype = Object.assign({}, FadingImages.prototype, {
      ...
      nextTitle: function() {
        ...
        window.setTimeout(function() {
          ...
          var newText3 = slide.getAttribute('data-slide-title3');
          this.container.querySelector('.fading-images-overlay__title--1').innerHTML = newText1;
          var textTwoContainer = this.container.querySelector('.fading-images-overlay__title--2');
          // var textThreeContainer = this.container.querySelector('.fading-images-overlay__title--3');
          if (textTwoContainer) {
            textTwoContainer.innerHTML = newText2;
          }
          // if (textThreeContainer) {
          //   textThreeContainer.innerHTML = newText3;
          // }
          this.allTitles.forEach(title => {
